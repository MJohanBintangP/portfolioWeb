      ...
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-16 justify-items-center">
          ...
          <div>
            ...
            <p className="text-white text-xs mt-4 lg:text-left text-center">Calm our mind . Mobile App</p>
          ...
          <div>
            ...
            <p className="text-white text-xs mt-4 lg:text-left text-center">Calm our mind . Web App</p>
            <h3 className="text-white text-xl font-semibold lg:text-left text-center">Mindease</h3>
          </div>
