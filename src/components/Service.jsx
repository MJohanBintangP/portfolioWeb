    ...
    <div className="max-w-[1800px] mx-auto mt-[15rem] mb-[15rem] px-4 md:px-8">
      ...
      <div className="max-w-[1250px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 text-left text-white">
        <div>
          ...
          <h2 className="font-regular text-[22px] md:text-[25px] text-[#252525] text-center md:text-left mb-6 md:mb-14">Mobile App Development</h2>
        ...
        <div>
          ...
          <h2 className="font-regular text-[22px] md:text-[25px] text-[#252525] text-center md:text-left mb-6 md:mb-14">Web App Development</h2>
        ...
        <div>
          ...
          <h2 className="font-regular text-[22px] md:text-[25px] text-[#252525] text-center md:text-left mb-6 md:mb-4">Mobile App and Web App Design</h2>
